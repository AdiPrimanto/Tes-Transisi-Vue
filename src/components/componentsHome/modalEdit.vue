    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn btn-sm" v-on:click="closeModalEdit">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" v-on:click="closeModalEdit">Close</button>
          <button type="submit" class="btn btn-primary" @click="handleEditSubmit(userIdEdit)">
            Edit
  ...
  export default {
    ...
    methods: {
      handleEditSubmit(userIdEdit) {
        ...
        axios.post('users/' + userIdEdit, data)
        .then(
            res => {
                console.log(res);
                this.name = '';
